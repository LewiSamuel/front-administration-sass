 ...
 */
// Post < -- > User
User.hasMany(Post, { foreignKey: 'u' } );
Post.belongsTo(User, { foreignKey: 'u' } );
...
import PostSearchController    from '../controller/Post/Search';
...
import PostSearchMid    from '../middleware/Post/Search';
...
routes.get("/search",          [ AuthToken, PostSearchMid ],     PostSearchController);
routes.get("/delete",          [ AuthToken, PostDeleteMid ],     PostDeleteController);
